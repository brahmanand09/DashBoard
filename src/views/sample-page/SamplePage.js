    ...
    <form className={styles.mainWrap}>
      <main className={styles.main}>
              ...
              <div className={styles.content}>
                ...
                <div className={styles.actions}>
                  <button className={styles.button1}>
                    <Link className={styles.buttonBase3} to={"/sample-page/projectForm"}>
        ...
        <div className={styles.header}>
          ...
          <button className={styles.tableRow2}>
            <div className={styles.financials}>Financials</div>
          </button>
          <Link className={styles.tableRow3} to={"/sample-page/deliverable"}>
